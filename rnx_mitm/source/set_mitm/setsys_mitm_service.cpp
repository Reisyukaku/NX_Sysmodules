        ...
        void CacheFirmwareVersion() {
            ...
            /* Modify the atmosphere firmware version to display a custom version string. */
            {
                ...
                #pragma GCC diagnostic ignored "-Wformat-truncation"
                {
                    ...
                    std::snprintf(display_version, sizeof(display_version), "%s ReiNX(%u.%u)", g_ams_firmware_version.display_version, api_info.GetMajorVersion(), api_info.GetMinorVersion());
