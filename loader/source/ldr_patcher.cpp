...
namespace ams::ldr {
    ...
    namespace {
        ...
        constexpr const char *NsoPatchesDirectory = "patches";
    ...
    /* Apply IPS patches. */
    void LocateAndApplyIpsPatchesToModule(const u8 *build_id, uintptr_t mapped_nso, size_t mapped_size, const ncm::ProgramId program_id) {
        ...
        ams::patcher::LocateAndApplyIpsPatchesToModule(LoaderSdMountName, NsoPatchesDirectory, NsoPatchesProtectedSize, NsoPatchesProtectedOffset, &module_id, reinterpret_cast<u8 *>(mapped_nso), mapped_size, program_id);
    }
