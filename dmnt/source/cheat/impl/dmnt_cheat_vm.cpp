...
namespace ams::dmnt::cheat::impl {
    ...
    void CheatVirtualMachine::DebugLog(u32 log_id, u64 value) {
        ...
        fs::EnsureDirectoryRecursively("sdmc:/ReiNX/cheat_vm_logs");

        fs::FileHandle log_file;
        {
            char log_path[fs::EntryNameLengthMax + 1];
            std::snprintf(log_path, sizeof(log_path), "sdmc:/ReiNX/cheat_vm_logs/%08x.log", log_id);
    ...
    void CheatVirtualMachine::OpenDebugLogFile() {
        ...
        CloseDebugLogFile();
        R_ABORT_UNLESS(fs::OpenFile(std::addressof(this->debug_log_file), "sdmc:/ReiNX/cheat_vm_logs/debug_log.txt"));
