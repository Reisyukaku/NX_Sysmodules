...
namespace ams::mitm::fs {
    ...
    namespace {
        ...
        constexpr const char AtmosphereHblWebContentDir[] = "/ReiNX/hbl_html/";
    ...
    Result FsMitmService::OpenSaveDataFileSystem(sf::Out<std::shared_ptr<IFileSystemInterface>> out, u8 _space_id, const fs::SaveDataAttribute &attribute) {
        ...
        FsFile flag_file;
        R_UNLESS(R_FAILED(OpenAtmosphereSdFile(&flag_file, "/ReiNX/saveredirection", OpenMode_Read)), sm::mitm::ResultShouldForwardToSession());
